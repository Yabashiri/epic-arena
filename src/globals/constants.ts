namespace Arena.Global {
    export class Constants {
        ...
        public static style_black = {font: "bold 14px Trebuchet MS", fill: "#000", align: "left"};
        public static style_black_small = {font: "bold 11px Trebuchet MS", fill: "#000", align: "left"};
        public static style_red = {font: "bold 14px Trebuchet MS", fill: "#ba1a1c", align: "left"};
        public static player_red = {font: "bold 18px Trebuchet MS", fill: "#ba1a1c"};
